...
```javascript
import itermean from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-mean@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-iter-mean/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/stats-iter-mean/actions/workflows/test.yml?query=branch:v0.2.3
